...
<main class="main-content">
    <section class="page-banner" style="background: var(--insea-green); color: var(--white); padding: 60px 5%; text-align: center;">
        <h1 style="font-size: 2.5rem; font-weight: 800;"><?php echo __('sfc_title'); ?></h1>
    </section>

    <section style="max-width: 1000px; margin: 60px auto; padding: 0 20px;">
        <div style="background: var(--white); padding: 40px; border-radius: 15px; box-shadow: var(--shadow-lg); margin-bottom: 40px;">
            <p style="font-size: 1.15rem; line-height: 1.8; color: var(--gray-800); margin-bottom: 30px; font-weight: 600;">
                <?php echo __('sfc_intro'); ?>
            </p>
            ...
            <ul style="list-style: none; padding: 0;">
                ...
                <li style="margin-bottom: 20px; padding-left: 30px; position: relative; line-height: 1.7; color: var(--gray-600);">
                    ...
                    <?php echo __('sfc_mission_' . $i); ?>
                </li>
                <?php endfor; ?>
            </ul>
        </div>

        <div style="background: var(--insea-green-light); padding: 30px; border-radius: 12px; border-right: 5px solid var(--insea-green); border-left: 5px solid var(--insea-green);">
            <p style="color: var(--insea-green-dark); font-weight: 700; font-size: 1.1rem; text-align: center;">
                <?php echo __('sfc_council'); ?>
            </p>
        </div>
    </section>
</main>
